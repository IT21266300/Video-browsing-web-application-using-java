	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="insertP" method="post">
	        	...
	        	<button type="submit" class="btn text-light" style="background:var(--clr-1)">Update</button>
	        </form>
	      </div>
	    </div>
	  </div>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="insertP1" method="post">
	        	<div class="mb-3">
				    <input type="text" name="lin" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Add new Last Name">
					<input type="text" name="user" value="<%=u%>" style="display:none;">
				</div>
	        	<button type="submit" class="btn text-light" style="background:var(--clr-1)">Update</button>
	        </form>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="insertP2" method="post">
	        	<div class="mb-3">
				    <input type="text" name="em" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Add new Email">
					<input type="text" name="user" value="<%=u%>" style="display:none;">
				</div>
	        	<button type="submit" class="btn text-light" style="background:var(--clr-1)">Update</button>
	        </form>
	...
	<div class="modal fade" id="uploadVideo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	     ...
	     <div class="mb-3">
	     	<input type="text" class="form-control" name="user" aria-describedby="emailHelp" value="<%=str1%>">
